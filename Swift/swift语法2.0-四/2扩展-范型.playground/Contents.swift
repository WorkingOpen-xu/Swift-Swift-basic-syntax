...
//
//        for i in self.stride(end: <#T##Int#>, by: <#T##Int#>, task: <#T##(Int)#>) {
//            task(i)
//        }
//
//    }
    
    func numIndexNum(index: Int) -> Any {
        var numStr: String = "\(self)"
        numStr = String(numStr.prefix(index + 1))
        numStr = String(numStr.suffix(1))
        return numStr
    }
}
